package com.sanish.booking_service.configurations;
...
//        admin.setAutoStartup(true); // Ensure it starts on context refresh
//        return admin;
//    }
...
//        return args -> {
//            System.out.println("Forcing RabbitAdmin.initialize()");
//            rabbitAdmin.initialize(); // Enforce declaration of all queue/exchange/bindings by init
//        };
//    }
}
